...
public class Proposer extends KeyValueStore {
    ...
    public void propose(List<String> acceptorPortsList, String hostName, List<String> acceptorServerNames,
                        String serverName, Integer portNumber) throws RemoteException {
...
//                if(result != proposerId) {
//                    // need to break the loop, the proposal failed.
//                    highestProposerId = result;
//                    LOGGER.info("Proposal Failed. Proposal Id quorum could not be reached.");
//                    break;
//                }
            } catch (RemoteException e) {
                e.printStackTrace();
